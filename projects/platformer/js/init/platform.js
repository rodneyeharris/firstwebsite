(function (window) {
    ...
    platform.init = function (game) {
        ...
        // example:
        platform.create(600, 599, 0.5 ,1);
        platform.create(600, 410, 0.5, 1);
        platform.create(50, 410, 0.5, 1);
        platform.create(50, 599, 0.5, 1);
        platform.create(50, 210, 0.5, 1);
        platform.create(600, 210, 0.5, 1);
